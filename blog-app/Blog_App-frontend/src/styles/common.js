...
// ─── Article Details / Individual Article ─────────────
export const articlePageWrapper = "max-w-4xl mx-auto px-6 py-16"
export const articleHeader      = "mb-10"
export const articleCategory    = "text-sm font-semibold text-[#0066cc] uppercase tracking-widest mb-3 block"
export const articleMainTitle   = "text-4xl lg:text-5xl font-bold text-[#1d1d1f] tracking-tight leading-tight mb-4"
export const articleAuthorRow   = "flex flex-col sm:flex-row sm:items-center justify-between gap-4 text-sm text-[#6e6e73] border-t border-[#e8e8ed] pt-6 mt-6"
export const authorInfo         = "font-medium text-[#1d1d1f] flex items-center gap-2"
export const articleContent     = "text-[#1d1d1f] leading-relaxed text-lg mb-12 whitespace-pre-wrap"
export const articleFooter      = "text-sm text-[#a1a1a6] border-t border-[#e8e8ed] pt-6 mt-12"
export const articleActions     = "flex items-center gap-4 mt-8 pt-6 border-t border-[#e8e8ed]"

// ─── Action Buttons ───────────────────────────────────
export const editBtn            = "bg-[#0066cc] text-white font-semibold px-6 py-2.5 rounded-full hover:bg-[#004499] transition-colors cursor-pointer text-sm tracking-tight"
export const deleteBtn          = "bg-[#ff3b30] text-white font-semibold px-6 py-2.5 rounded-full hover:bg-[#cc2f26] transition-colors cursor-pointer text-sm tracking-tight"